...
export const individualMagic = [
  {
    ...
    icon: '✨',
    gifUrl: 'https://media.giphy.com/media/VGG8UY1nEl66Y/giphy.gif', // "Upgrade" button meme
  ...
  },
  {
    ...
    icon: '💘',
    gifUrl: 'https://media.giphy.com/media/l0HlIHz7I8Vlgj5Ty/giphy.gif', // Heart eyes emoji meme
  ...
  },
  {
    ...
    icon: '🤫',
    gifUrl: 'https://media.giphy.com/media/3oEjI5VtIhHvK37WYo/giphy.gif', // Shh quiet meme
...
export const salonMagic = [
  {
    ...
    icon: '🎊',
    gifUrl: 'https://media.giphy.com/media/g9582DNuQppxC/giphy.gif', // Confetti celebration
  ...
  },
  {
    ...
    name: 'Vote Magique',
    icon: '🗳️',
    gifUrl: 'https://media.giphy.com/media/l3fQjHugtGrGhHs5y/giphy.gif', // Voting button
...
export const classicGifts = [
  {
    ...
    icon: '🍕',
    gifUrl: 'https://media.giphy.com/media/rSCVJasn8uZP2/giphy.gif', // Delicious pizza GIF
  ...
  },
  {
    ...
    icon: '🧀',
    gifUrl: 'https://media.giphy.com/media/3oKIPnHoHbanatScXC/giphy.gif', // Melted cheese GIF
  ...
  },
  {
    ...
    icon: '🍹',
    gifUrl: 'https://media.giphy.com/media/l46CbYFENkqbvpfXO/giphy.gif', // Cocktail drink GIF
  ...
  },
  {
    ...
    icon: '💆',
    gifUrl: 'https://media.giphy.com/media/26BRuo6sLetdllPAQ/giphy.gif', // Relaxing spa GIF
  ...
  },
  {
    ...
    name: 'Excuse Ultime',
    icon: '🎭',
    gifUrl: 'https://media.giphy.com/media/LRVnPYqM8DLag/giphy.gif', // Awkward/running away meme
...
export const humorGifts = [
  ...
  },
  {
    ...
    name: 'Compliment Box',
    icon: '💝',
    gifUrl: 'https://media.giphy.com/media/3oz8xIsloV7zOmt81G/giphy.gif', // Wholesome heart GIF
  ...
  },
  {
    ...
    icon: '🌈',
    gifUrl: 'https://media.giphy.com/media/11sBLVxNs7v6WA/giphy.gif', // Happy rainbow GIF
  ...
  },
  {
    ...
    icon: '👻',
    gifUrl: 'https://media.giphy.com/media/l1J9EdzfOSgfyueLm/giphy.gif', // "Block" button meme
...
export const premiumGifts = [
  {
    ...
    icon: '💎',
    gifUrl: 'https://media.giphy.com/media/3oEduOnl5IHM5NRodO/giphy.gif', // Sparkling diamonds GIF
  ...
  },
  {
    ...
    icon: '🧪',
    gifUrl: 'https://media.giphy.com/media/POql6zsXZbmcE/giphy.gif', // "Nope" button meme
  ...
  },
  {
    ...
    icon: '🧪',
    gifUrl: 'https://media.giphy.com/media/QUENDfi6DEMLzQ0CKt/giphy.gif', // "No thanks" GIF
  ...
  },
  {
    ...
    icon: '🩲',
    gifUrl: 'https://media.giphy.com/media/dSetNZo2AJfptAk9hp/giphy.gif', // Superhero cape/power GIF
