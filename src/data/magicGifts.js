...
export const individualMagic = [
  {
    ...
    icon: '✨',
    gifUrl: 'https://media.giphy.com/media/3o7btPCcdNniyf0ArS/giphy.gif', // Sparkles/magic sparkle effect
  ...
  },
  {
    ...
    icon: '💘',
    gifUrl: 'https://media.giphy.com/media/R6gvnAxj2ISzJdbA63/giphy.gif', // Heart detector/radar
  ...
  },
  {
    ...
    icon: '⚡',
    gifUrl: 'https://media.giphy.com/media/hEc4k5pN17GZq/giphy.gif', // Confused John Travolta ✅ PARFAIT
  ...
  },
  {
    ...
    icon: '🤫',
    gifUrl: 'https://media.giphy.com/media/26gJy9p3W2PPkDkbu/giphy.gif', // Shh finger to lips
...
export const salonMagic = [
  {
    ...
    icon: '🎊',
    gifUrl: 'https://media.giphy.com/media/26tPnAAJxXTvpLwJy/giphy.gif', // Raining emojis/confetti
  ...
  },
  {
    ...
    name: 'Vote Magique',
    icon: '🗳️',
    gifUrl: 'https://media.giphy.com/media/3o7aCRloybJlXpNjSU/giphy.gif', // Daily struggle 2 buttons
  ...
  },
  {
    ...
    name: 'Sort du Chaos',
    icon: '🎲',
    gifUrl: 'https://media.giphy.com/media/NTur7XlVDUdqM/giphy.gif', // "This is fine" dog ✅ PARFAIT
...
export const classicGifts = [
  {
    ...
    icon: '🍕',
    gifUrl: 'https://media.giphy.com/media/fBGy9GPvF3QwCPQt9f/giphy.gif', // Delicious pizza rotating
  ...
  },
  {
    ...
    icon: '🧀',
    gifUrl: 'https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif', // Cheese stretching/melting
  ...
  },
  {
    ...
    icon: '🍹',
    gifUrl: 'https://media.giphy.com/media/l0IycI0rreFNQwmSQ/giphy.gif', // Tropical cocktail drink
  ...
  },
  {
    ...
    name: 'Sieste Premium',
    icon: '😴',
    gifUrl: 'https://media.giphy.com/media/krP2NRkLqnKEg/giphy.gif', // Sleeping cat ✅ PARFAIT
  ...
  },
  {
    ...
    icon: '💆',
    gifUrl: 'https://media.giphy.com/media/GEoDgASYAYXjq/giphy.gif', // Spa massage relaxation
  ...
  },
  {
    ...
    name: 'Excuse Ultime',
    icon: '🎭',
    gifUrl: 'https://media.giphy.com/media/4pMX5rJ4PYAEM/giphy.gif', // Homer Simpson bushes ✅ PARFAIT
...
export const humorGifts = [
  {
    ...
    icon: '🤣',
    gifUrl: 'https://media.giphy.com/media/Wt6kNaMjofj1jHkF7t/giphy.gif', // Stonks ✅ PARFAIT
  ...
  },
  {
    ...
    name: 'Compliment Box',
    icon: '💝',
    gifUrl: 'https://media.giphy.com/media/l0HlQ2nO8eElDDRXq/giphy.gif', // Gift box opening with hearts
  ...
  },
  {
    ...
    icon: '🌈',
    gifUrl: 'https://media.giphy.com/media/l0MYGb1LuZ3n7dRnO/giphy.gif', // Double rainbow ✅ PARFAIT
  ...
  },
  {
    ...
    icon: '👻',
    gifUrl: 'https://media.giphy.com/media/KRG6XGnCYB0L6/giphy.gif', // Ghost busters logo/crossed out ghost
...
export const premiumGifts = [
  ...
  },
  {
    ...
    icon: '🧪',
    gifUrl: 'https://media.giphy.com/media/3oEjHCWdU7F4hkcudy/giphy.gif', // Magic potion bubbling
  ...
  },
  {
    ...
    icon: '🧪',
    gifUrl: 'https://media.giphy.com/media/3o6Zt0hNCfak3QCqsw/giphy.gif', // Pink magic potion
